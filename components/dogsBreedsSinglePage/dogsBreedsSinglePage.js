            ...
            <SafeAreaView style={styles.container} >
               <ScrollView>
                   ...
                   <View style={styles.top_panel}>
                       <TouchableOpacity style={styles.back_to_dog_breeds_page_btn}  onPress={this.redirectToDogsBreeds}>
                           <Svg
                               width={26}
                               height={26}
                               viewBox="0 0 18 12"
                 ...
                 <LinearGradient colors={['#E1C1B7', '#FFFFFF']} style={styles.dogs_breeds_wrapper} >
                    ...
                    <View style={styles.slider_wrapper}>
                        ...
                        <View style={styles.slider_length}>
                            ...
                            <Text style={styles.slider_text}>{this.state.dog.slider_images.length}</Text>
                    ...
                    <SingleVideo style={styles.video_box} video_url={{url: this.state.dog.video_url}}/>

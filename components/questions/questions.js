...
import Svg, { Path, Rect, Circle, Defs, Stop, Pattern } from "react-native-svg";
...
export default class App extends Component {
    ...
    getQuestions = () => {
        return this.state.questions_answers;
    }
            ...
            <SafeAreaView style={styles.container} >
                ...
                <LinearGradient colors={['#E1C1B7', '#FFFFFF']} style={styles.dogs_breeds_wrapper} >
                    ...
                    <ScrollView style={styles.dogs_items_scrollView}>
                        ...
                        {this.getQuestions().map((questions_answers, index) => {
                            return (

                                <View style={styles.questions_answers_main_wrapper} key={questions_answers.id} >
                                     <Text style={styles.questions_answers_title}>
                                         {questions_answers.title}
                                     </Text>
                                       <View style={styles.questions_answers_radio_inputs_title_main_wrapper}>
                                           <View style={styles.questions_answers_radio_inputs_title_wrapper}>
                                               {questions_answers.answers.map((answer, index) => {
                                                   return (

                                                       <View style={styles.questions_answers_radio_input_title}>
                                                           <TouchableOpacity style={styles.inputRadio}>
                                                           ...
                                                           <Text style={styles.questions_answers_input_title}>
                                                               {answer}
                                                           </Text>
                                                       </View>
                    ...
                    <LinearGradient colors={['#c9a477', '#b56422']} style={styles.complete_button_parent} >
                        <TouchableOpacity style={styles.complete_btn}>
                            <Text style={styles.complete_btn_text}>Завершить</Text>
...
const styles = StyleSheet.create({
    ...
    questions_answers_radio_input_title: {
        flexDirection: "row",
        alignItems: "center",
        marginBottom: 10,
    },
    questions_answers_input_title: {
        color: "#b56422",
        fontSize: 14,
    },
    ...
    questions_answers_main_wrapper: {
        backgroundColor: "#FFFFFF",
        shadowColor: "#b56422",
        shadowOffset: {
            width: 0,

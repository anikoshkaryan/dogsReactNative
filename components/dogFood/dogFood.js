...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            dogsFood: [
                {
                    id: 1,
                    name: "Корм для породы -Бульдог",
                    info: "Royal Canin" ,
                    isWish: false,
                    img: require('../../assets/images/dog_food_img1.png'),
                    slider_images: [
                        require('../../assets/images/dog_food_img1.png'),
                        require('../../assets/images/buldog_food_slider_img3.jpg'),
                        require('../../assets/images/buldog_foog_slider_img2.jpg')
                    ],
                ...
                {
                    id: 2,
                    name: "Корм для породы - Хаски",
                    info: "Dog Chow" ,
                    isWish: false,
                    img: require('../../assets/images/dog_food_img2.jpg'),
                    slider_images: [
                        require('../../assets/images/dog_food_img2.jpg'),
                        require('../../assets/images/xaski_food_slider_img3.jpg'),
                        require('../../assets/images/xaski_food_slider_img2.jpg')
                ...
                {
                    id: 3,
                    name: "Корм для породы -  Чихуахуа",
                    info:"Royal Canin" ,
                    isWish: true,
                    img: require('../../assets/images/dog_food_img3.png'),
                    slider_images: [
                        require('../../assets/images/dog_food_img3.png'),
                        require('../../assets/images/chixuxaya_food_slider_img3.jpg'),
                        require('../../assets/images/chixuxaya_food_slider_img2.jpg')
                    ],
                    video_url: 'http://d23dyxeqlo5psv.cloudfront.net/big_buck_bunny.mp4',
                ...
                {
                    id: 4,
                    name: "Корм для породы -  Овчарка",
                    info: "Royal Canin" ,
                    isWish: false,
                    img: require('../../assets/images/dog_food_img4.png'),
                    slider_images: [
                        require('../../assets/images/dog_food_img4.png'),
                        require('../../assets/images/ovcharka_food_slider_img3.jpg'),
                        require('../../assets/images/ovcharka_food_slider_img4.jpg')
                    ],
                    video_url: 'http://d23dyxeqlo5psv.cloudfront.net/big_buck_bunny.mp4',
    ...
    redirectToDogsFoodSinglePage = (dogsFood) => {
        this.closeModal();
        this.props.navigation.navigate("DogsFoodSinglePage", {
            params:dogsFood,
        });
    }
    render() {
        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <LinearGradient colors={['#E1C1B7', '#FFFFFF']} style={styles.dogs_breeds_wrapper} >
                    ...
                    <View style={styles.dog_food_dropdown_menu_wrapper}>
                            ...
                            // iconColor='#E1E1E1'
                            label='Породы собак'
                            data={this.state.dogsBreedsCategoriesItems}
                            style={styles.dog_food_dropdown_menu}
                            underlineColor='transparent'
                            baseColor="#b56422"
                            textColor="#b56422"
                            disabledItemColor="#b56422"
                            selectedItemColor="#b56422"
                            itemColor="#b56422"
                            labelContainerStyle="#b56422"
                            rippleColor="#b56422"
                    ...
                    <ScrollView style={styles.dogs_items_scrollView}>
                        ...
                        {this.getDogs().map((dogsFood, index) => {
                            return (

                                <TouchableOpacity style={styles.dog_img_info_main_wrapper} key={dogsFood.id} onPress={() => this.redirectToDogsFoodSinglePage(dogsFood)} >
                                    <View style={styles.dog_img_box}>
                                        <View style={styles.dog_img}>
                                            <Image style={styles.dog_img_child}  source={dogsFood.img} />
                                        </View>
                                    ...
                                    <View style={styles.dog_info_main_wrapper}>
                                        ...
                                        <Text style={styles.dog_info}> {dogsFood.info} </Text>
...
const styles = StyleSheet.create({
    ...
    dog_food_dropdown_menu_wrapper: {
      marginBottom: 30,
    },
